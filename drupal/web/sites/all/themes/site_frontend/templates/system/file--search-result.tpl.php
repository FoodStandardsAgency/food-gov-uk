...
/**
 * @file
 * Theme implementation to display a file in site search results.
 *
 * Available variables:
 ...
 * - $icon: A file icon to output alongside the title and link to the file
 *
 ...
 * @see site_frontend_preprocess_file_entity()
 *
 * @ingroup themeable
 */
?>
<div id="<?php print $id; ?>" class="<?php print $classes ?>"<?php print $attributes; ?>>
  ...
  <?php if (!$page): ?>
    <h3<?php print $title_attributes; ?>><?php print $icon; ?> <a href="<?php print $file_url; ?>"><?php print $label; ?></a></h3>
  <?php endif; ?>
  ...
  <div class="content node__content"<?php print $content_attributes; ?>>
    <?php
