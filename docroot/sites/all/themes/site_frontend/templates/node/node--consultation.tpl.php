...
<article<?php print $attributes; ?>>
  ...
  <div<?php print $content_attributes; ?>>
    ...
    ?>
    <?php
    /// Standard consultation elements
    $further_info_uuid =
    ...
    <div>
      <h2>Publication of personal data and confidentiality of responses </h2>
      <div>
        <p>In accordance with the FSA principle of openness we shall keep a copy of the completed consultation and responses, to be made available to the public on request. The FSA will publish a summary of responses, which may include personal data, such as your full name. Disclosure of any other personal data would be made only upon request for the full consultation responses. If you do not want this information to be released, please complete and return the Publication of Personal Data Form. Return of this form does not mean that we will treat your response to the consultation as confidential, just your personal data.</p>
      </div>
    </div>
    <div>
      <h2>Publication of response summary</h2>
      <div>
        <p>
