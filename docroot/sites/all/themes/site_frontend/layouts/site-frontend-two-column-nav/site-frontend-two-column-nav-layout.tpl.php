...
/**
 * @file
 * Site frontend two column with left navigation layout
 *
 * Content that would normally appear in the right-hand column in the sidebar
 * second region now appears beneath the left-hand navigation within the
 * markup for the sidebar_first region.
 */
?>

<!-- begin site-frontend-two-column-nav-layout.tpl.php -->
<div class="l-page">
...
<!-- end site-frontend-two-column-nav-layout.tpl.php -->
